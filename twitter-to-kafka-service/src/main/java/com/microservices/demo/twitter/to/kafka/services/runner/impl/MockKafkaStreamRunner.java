...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public void start() throws TwitterException {
        ...
        simulatedTwitterStream(keywords, minTweetLength, maxTweetLength, sleepTimeMs);

    }

    private void simulatedTwitterStream(String[] keywords, int minTweetLength, int maxTweetLength, long sleepTimeMs) {
